...
const PROV_KLEUREN = {
  "Noord-Holland":"#68749c","Zuid-Holland":"#7a98ad","Utrecht":"#8c6848",
  "Noord-Brabant":"#eb7e13","Gelderland":"#7a98ad","Overijssel":"#68749c",
  "Groningen":"#8c6848","Drenthe":"#7a98ad","Friesland":"#68749c",
  "Limburg":"#8c6848","Zeeland":"#7a98ad","Flevoland":"#eb7e13"
};

const CTMH_PROFIELEN = [
  { id:"sociaal", label:"Sociaal Domein", kleur:"#eb7e13", icon:"👥",
  ...
  { id:"ruimtelijk", label:"Ruimtelijk Domein", kleur:"#7a98ad", icon:"🏗️",
...
// ── CTMH Mensen / Adviseurs (actueel) ───────────────────────────────────────
const CTMH_MENSEN = [
  {
    id:"wim", naam:"Wim van Twuijver",
    rol:"Directeur & Gemeentesecretaris a.i.", initialen:"WvT",
    kleur:"#eb7e13", avatar:"🏛️",
    expertise:["bestuur","gemeentesecretaris","gemeentedirecteur","organisatieontwikkeling",
      "regionale samenwerking","fusie","hrm","financiën","bestuurszaken","sed"],
    profielen:["bestuur","hrm","financien"],
    bio:"Directeur CTMH. Voormalig gemeentesecretaris/algemeen directeur bij o.a. Hollands Kroon, Drechterland, Stede Broec en Enkhuizen (SED). Ruime ervaring in complexe bestuurlijke opgaven en organisatieontwikkeling.",
    regio:"Noord-Holland", beschikbaar:true
  },
  {
    id:"jeroen", naam:"Jeroen van Duijnhoven",
    rol:"Senior HR-adviseur & Organisatieadviseur", initialen:"JvD",
    kleur:"#8c6848", avatar:"🧑‍💼",
    ...
    bio:"Bedrijfskundige met ruime ervaring in strategische HR-advisering en verandertrajecten bij gemeentelijke overheidsorganisaties. Evenwichtig en resultaatgericht.",
    regio:"Noord-Holland / Landelijk", beschikbaar:true
  },
  {
    id:"anne", naam:"Anne Makenbach",
    rol:"Organisatieadviseur & Bestuurssecretaris", initialen:"AM",
    kleur:"#68749c", avatar:"🏛️",
    expertise:["organisatieontwikkeling","bestuur","bestuurssecretaris","procesbegeleiding",
      "organisatieadvies","regisseur","projectleider","directiesecretaris","samenwerking"],
    profielen:["bestuur","hrm"],
    bio:"Jarenlange ervaring in adviseren van organisaties bij organisatieontwikkeling. Zorgt voor rust en overzicht, uitstekend klankbord. Inzetbaar als regisseur, projectleider of directiesecretaris.",
    regio:"Landelijk", beschikbaar:true
  },
  {
    id:"daan", naam:"Daan van Gulik",
    rol:"Adviseur & Projectleider Ruimtelijk / Bestuur", initialen:"DvG",
    kleur:"#7a98ad", avatar:"🏗️",
    expertise:["duurzaamheid","participatie","omgevingsbeleid","ruimtelijk domein",
      ...
      "Programma Landelijk Gebied","bestuurlijke dossiers"],
    profielen:["ruimtelijk","bestuur","sociaal"],
    bio:"Analytisch sterk, bestuurlijk sensitief. Specialisme in duurzaamheidsvraagstukken, participatie en Programma Landelijk Gebied. Beweegt goed in complexe bestuurlijke omgevingen.",
    regio:"Landelijk / Friesland", beschikbaar:true
  },
  {
    id:"femke", naam:"Femke Sleegers",
    rol:"Interimmanager / Adviseur Publiek Domein", initialen:"FS",
    kleur:"#eb7e13", avatar:"🔗",
    expertise:["interimmanagement","gemeenschappelijke regelingen","waterschappen",
      "bestuurlijk","ambtelijk","organisatie","verandering","verbinding",
      "procesmanagement","Brabant"],
    profielen:["bestuur","sociaal","hrm"],
    bio:"Interimmanager-adviseur met brede ervaring bij gemeenten, gemeenschappelijke regelingen en waterschappen. Verbinder en bruggenbouwer. Actief in Brabant en omliggende regio's.",
    regio:"Noord-Brabant / Landelijk", beschikbaar:true
  },
  {
    id:"frank", naam:"Frank",
    rol:"Projectleider & Adviseur", initialen:"F",
    kleur:"#8c6848", avatar:"📋",
    expertise:["projectleider","adviseur","innovatie","signaleren","anticiperen",
      "verbinder","beleid","complexe omgeving","publiek domein"],
    profielen:["bestuur","ruimtelijk"],
    bio:"Professional actief als projectleider en adviseur op diverse beleidsterreinen. In staat te schakelen in complexe omgevingen. Met zijn natuurlijke charme een verbinder; enthousiast en resultaatgericht.",
    regio:"Landelijk", beschikbaar:true
  },
  {
    id:"marleen", naam:"Marleen Specht-Althuizen",
    rol:"Programmamanager / Projectleider Ruimtelijk Domein", initialen:"MS",
    kleur:"#7a98ad", avatar:"🏗️",
    expertise:["ruimtelijk domein","programmamanager","projectleider","woningbouw",
      "omgevingsbeleid","gebiedsontwikkeling","ruimtelijke ordening",
      "duurzaamheid","energietransitie","leiderschap"],
    profielen:["ruimtelijk"],
    bio:"Bewezen staat van dienst als programmamanager en projectleider in het ruimtelijk domein. Combineert strategisch inzicht met hands-on mentaliteit. Realiseert doelen in complexe projecten.",
    regio:"Landelijk", beschikbaar:true
  },
  {
    id:"iman", naam:"Iman Biesheuvel",
    rol:"Projectleider Economie & Gebiedsontwikkeling", initialen:"IB",
    kleur:"#8c6848", avatar:"💰",
    ...
    bio:"Projectleider economie bij o.a. Gemeente Amsterdam Stadsdeel West. Specialisme in vitaliteit van bedrijventerreinen en binnenstedelijke gebiedsontwikkeling.",
    regio:"Noord-Holland / Randstad", beschikbaar:false
  },
  {
    id:"anton", naam:"Anton",
    rol:"Adviseur / Casemanager Sociaal Domein", initialen:"A",
    kleur:"#68749c", avatar:"👥",
    ...
    profielen:["sociaal"],
    bio:"Combineert vakkennis met sterke focus op samenwerking. Daadkrachtige professional die denkt in mogelijkheden en zich richt op gezamenlijk succes in het sociaal domein.",
    regio:"Landelijk", beschikbaar:true
  },
  {
    id:"noa", naam:"Noa Huibers",
    rol:"Junior Adviseur Sociaal Domein", initialen:"NH",
    kleur:"#eb7e13", avatar:"👥",
    expertise:["sociaal domein","beleid","participatie","jeugd","welzijn",
      "sociale vraagstukken","onderzoek","advies","publieke sector"],
    profielen:["sociaal"],
    bio:"Afgestudeerde professional klaar om universitaire kennis in te zetten binnen het sociaal domein bij publieke organisaties. Frisse blik met stevige wetenschappelijke basis.",
    regio:"Landelijk", beschikbaar:true
  },
  {
    id:"suzanne", naam:"Suzanne Barnhoorn-Bakker",
    rol:"Adviseur Bestuur & Organisatie", initialen:"SB",
    kleur:"#7a98ad", avatar:"🏛️",
    expertise:["bestuur","bestuurssecretaris","organisatie","advies","kwaliteit",
      "ondersteuning","ontwikkeling","interim","bestuurlijk"],
    profielen:["bestuur","hrm"],
    bio:"Adviseur bestuur en organisatie met ervaring in bestuurlijke ondersteuning en organisatieontwikkeling. Praktisch en kwaliteitsgericht.",
    regio:"Landelijk", beschikbaar:true
  },
  {
    id:"esmee", naam:"Esmee",
    rol:"Juridisch Adviseur", initialen:"E",
    kleur:"#68749c", avatar:"⚖️",
    ...
    bio:"Scherp analytisch inzicht gecombineerd met sterk verantwoordelijkheidsgevoel. Verbindt juridische en maatschappelijke vraagstukken. HBO Rechten.",
    regio:"Landelijk", beschikbaar:true
  },
  {
    id:"hans", naam:"Hans Luiten",
    rol:"Docent & Adviseur Bestuurskunde", initialen:"HL",
    kleur:"#8c6848", avatar:"🎓",
    expertise:["bestuurskunde","beleidsadviseur","wethouder","stadsdeelvoorzitter",
      "politiek","bestuurlijk ambtelijke samenwerking","masterclass","opleiding"],
    profielen:["bestuur"],
    bio:"Docent beleids- en bestuurskunde met uitgebreide praktijkervaring als wethouder en stadsdeelvoorzitter. Geeft masterclass 'De Politieke Wereld en Jij' bij CTMH.",
    regio:"Landelijk", beschikbaar:true
  }
];
...
// ── UI Components ────────────────────────────────────────────────────────────
// ── Coalitieakkoord URL generator ───────────────────────────────────────────
function getAkkoordUrl(gemeente) {
  const naam = gemeente.toLowerCase()
    .replace(/['']/g,"")
    .replace(/\s+/g,"-")
    .replace(/[^a-z0-9-]/g,"");
  return "https://www.google.com/search?q=coalitieakkoord+2026+" + encodeURIComponent(gemeente) + "+gemeente+pdf";
}

function getGemeenteWebsite(gemeente) {
  const naam = gemeente.toLowerCase()
    .replace(/[''s-]/g,"")
    .replace(/\s+/g,"")
    .replace(/[^a-z0-9]/g,"");
  return "https://www." + naam + ".nl";
}

function MatchBar({ pct, kleur }) {
  return (
    <div style={{ background:"#fdf9f4", borderRadius:4, height:7, overflow:"hidden", flex:1 }}>
...
function ProvBadge({ provincie }) {
  const kleur = PROV_KLEUREN[provincie] || "#6a5a44";
  return (
...
function NLKaart({ gemeenteData, geselecteerd, onSelect, profielFilter, persoonFilter, zoek, provFilter }) {
  ...
  const legendItems = [
    { label:"80%+", min:80, kleur:"#1a1208" },
    { label:"60-79%", min:60, kleur:"#3a2a14" },
    { label:"40-59%", min:40, kleur:"#8c7050" },
    { label:"20-39%", min:20, kleur:"#8c6848" },
  ...
  return (
    <div style={{ position:"relative", width:"100%", background:"#faf7f3",
      borderRadius:12, overflow:"hidden", border:"1px solid #e8dcc8" }}>
        ...
        <div style={{ display:"flex", gap:8, alignItems:"center" }}>
          {legendItems.map(l => (
            <div key={l.label} style={{ display:"flex", alignItems:"center", gap:3 }}>
              ...
              <span style={{ fontSize:9, color:"#8a7860" }}>{l.label}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <svg viewBox={"0 0 " + MAP_W + " " + MAP_H}
        ...
        <rect width={MAP_W} height={MAP_H} fill="#faf7f3" />

        {/* Water */}
        <rect x="0" y="0" width="110" height={MAP_H} fill="#1a1208" opacity="0.4" />
        <rect x="0" y="0" width={MAP_W} height="60" fill="#1a1208" opacity="0.3" />

        {/* Grid lijnen */}
        {[51,52,53].map(lat => {
          const [,y] = latLngToXY(lat, 5);
          return <line key={lat} x1="0" y1={y} x2={MAP_W} y2={y}
            stroke="#1a1208" strokeWidth="0.5" strokeDasharray="4,6" />;
        })}
        {[4,5,6,7].map(lng => {
        ...
        {punten.filter(p => p.inwoners > 120000).map(p => (
          <text key={p.gemeente+"_lbl"} x={p.x+getRadius(p.inwoners)+4} y={p.y+4}
            fontSize="9" fill="#5a4228" style={{ pointerEvents:"none" }}>
            {p.gemeente}
          </text>
        ))}

        {/* Kompas */}
        <text x={MAP_W-20} y={25} fontSize="12" fill="#8a7860" textAnchor="middle">N</text>
        <line x1={MAP_W-20} y1={30} x2={MAP_W-20} y2={45} stroke="#8a7860" strokeWidth="1" />
      </svg>

      {/* Tooltip */}
      {tooltip && (
        <div style={{ position:"fixed", left:tooltip.mx+12, top:tooltip.my-10,
          background:"#eb7e1315", border:"1px solid "+tooltip.g.kleur,
          borderRadius:8, padding:"8px 12px", pointerEvents:"none",
          zIndex:9999, minWidth:180, boxShadow:"0 4px 20px #00000066" }}>
          <div style={{ fontWeight:700, color:"#1a1208", fontSize:13, marginBottom:3 }}>
            {tooltip.g.gemeente}
          </div>
          ...
          <div style={{ marginTop:6, fontSize:10, color:"#8a7860" }}>
            Klik voor analyse
          </div>
        </div>
      )}
...
export default function App() {
  ...
  const ST = {
    page: { minHeight:"100vh", background:"#f7f3ef", color:"#1a1208",
      fontFamily:"Inter,system-ui,sans-serif", display:"flex", flexDirection:"column" },
    hdr: { background:"#ffffff", borderBottom:"2px solid #eb7e13",
      padding:"12px 20px", display:"flex", alignItems:"center", gap:12,
      boxShadow:"0 2px 8px #eb7e1318" },
    left: { width:285, flexShrink:0, background:"#ffffff",
      borderRight:"1px solid #e8d8c0", display:"flex",
      flexDirection:"column", overflow:"hidden" },
    right: { flex:1, overflow:"auto", padding:16, background:"#f7f3ef" },
    inp: { width:"100%", background:"#faf7f3", border:"1px solid #d8c8b0",
      borderRadius:8, padding:"7px 10px", color:"#1a1208", fontSize:12,
      outline:"none", boxSizing:"border-box" },
    sel: { width:"100%", background:"#faf7f3", border:"1px solid #d8c8b0",
      borderRadius:8, padding:"6px 10px", color:"#1a1208",
      fontSize:12, outline:"none", cursor:"pointer" },
    card: { background:"#ffffff", border:"1px solid #e8d8c0", borderRadius:12,
      padding:"14px 18px", boxShadow:"0 1px 4px #00000008" },
    tab: (a) => ({ background:a?"#eb7e13":"#ffffff",
      border:"1px solid "+(a?"#eb7e13":"#d8c8b0"), borderRadius:7,
      padding:"6px 12px", color:a?"#ffffff":"#6a5a44",
  ...
  return (
    <div style={ST.page}>
      ...
      <div style={ST.hdr}>
        ...
        <div style={{flex:1}}>
          <div style={{fontSize:16,fontWeight:800,letterSpacing:"-0.3px"}}>
            <span style={{color:"#eb7e13"}}>CTMH</span>
            <span style={{color:"#1a1208"}}> Kansen Analyse</span>
          </div>
          <div style={{fontSize:10,color:"#8a7860"}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          <div style={{background:"#e8d8c0",borderRadius:8,padding:"5px 10px",textAlign:"center"}}>
            <div style={{fontSize:10,color:"#8a7860"}}>Week</div>
            <div style={{fontSize:16,fontWeight:800,color:"#eb7e13"}}>{getWeekNumber()}</div>
          </div>
          <button onClick={forceRefresh}
            style={{background:"#e8d8c0",border:"1px solid #eb7e13",borderRadius:8,
              padding:"5px 10px",color:"#eb7e13",fontSize:10,cursor:"pointer",fontWeight:700}}>
            {weekLoading ? "..." : "↻ Refresh"}
          </button>
        </div>
      </div>
      ...
      {(weekUpdate || weekLoading) && (
        <div style={{background:"linear-gradient(90deg,#1a1208,#fef5e8)",
          borderBottom:"1px solid #1e3a5f",padding:"10px 20px",
          display:"flex",alignItems:"flex-start",gap:12}}>
          <div style={{fontSize:20,flexShrink:0}}>📡</div>
          <div style={{flex:1}}>
            <div style={{fontSize:11,fontWeight:700,color:"#eb7e13",marginBottom:3}}>
              WEKELIJKSE KANSEN UPDATE — Week {getWeekNumber()}/2026
              {lastRefresh && (
                <span style={{color:"#8a7860",fontWeight:400,marginLeft:8}}>
                  · {new Date(lastRefresh).toLocaleDateString("nl-NL")}
                </span>
              )}
            </div>
            {weekLoading ? (
              <div style={{color:"#8a7860",fontSize:12}}>Update wordt gegenereerd...</div>
            ) : (
              <div style={{fontSize:12,color:"#5a4228",lineHeight:1.6,
            ...
            <div style={{display:"flex",gap:5,flexShrink:0}}>
              {nieuweSignalen.slice(0,3).map(s=>(
                <div key={s.gemeente}
                  ...
                  <div style={{fontSize:10,fontWeight:700,color:"#1a1208"}}>{s.gemeente}</div>
      ...
      <div style={{display:"flex",flex:1,overflow:"hidden",minHeight:0}}>
        {/* Linkerpaneel */}
        <div style={ST.left}>
          <div style={{padding:"10px 10px 8px",borderBottom:"1px solid #e8dcc8",
            ...
            <div style={{display:"flex",flexWrap:"wrap",gap:3}}>
              <button onClick={()=>{setProfielFilter(null);setPersoonFilter(null);}}
                style={{background:(!profielFilter&&!persoonFilter)?"#eb7e1322":"#fdf9f4",
                  border:"1px solid "+((!profielFilter&&!persoonFilter)?"#eb7e13":"#e8d8c0"),
                  borderRadius:20,padding:"2px 8px",color:(!profielFilter&&!persoonFilter)?"#eb7e13":"#8a7860",
              ...
              {CTMH_PROFIELEN.map(p=>(
                <button key={p.id} onClick={()=>{setProfielFilter(p.id===profielFilter?null:p.id);setPersoonFilter(null);}}
                  style={{background:(!persoonFilter&&profielFilter===p.id)?p.kleur+"22":"#fdf9f4",
                    border:"1px solid "+((!persoonFilter&&profielFilter===p.id)?p.kleur:"#e8d8c0"),
                    borderRadius:20,padding:"2px 7px",
                    color:(!persoonFilter&&profielFilter===p.id)?p.kleur:"#8a7860",
            ...
            {/* Persoon filter */}
            <div style={{borderTop:"1px solid #e8dcc8",paddingTop:7}}>
              <div style={{fontSize:9,fontWeight:700,color:"#8a7860",letterSpacing:1,marginBottom:5,textTransform:"uppercase"}}>
              ...
              <div style={{display:"flex",flexWrap:"wrap",gap:3}}>
                {CTMH_MENSEN.map(m=>(
                  <button key={m.id}
                    ...
                    title={m.naam + " — " + m.rol}
                    style={{
                      background:persoonFilter?.id===m.id?m.kleur+"33":"#fdf9f4",
                      border:"1px solid "+(persoonFilter?.id===m.id?m.kleur:"#e8d8c0"),
                      borderRadius:20,padding:"3px 8px",
                      color:persoonFilter?.id===m.id?m.kleur:"#8a7860",
                    ...
                    {!m.beschikbaar && <span style={{color:"#8a7860",fontSize:9}}>·</span>}
                  </button>
                ))}
              </div>
              {persoonFilter && (
                <div style={{marginTop:6,background:persoonFilter.kleur+"11",
                  ...
                  <div style={{fontSize:10,color:"#8a7860",marginTop:1}}>{persoonFilter.rol}</div>
                  <div style={{fontSize:9,color:"#8a7860",marginTop:3}}>
          ...
          <div style={{padding:"4px 10px",fontSize:10,color:"#8a7860",
            ...
            {gefilterd.map(g => {
              ...
              return (
                <div key={g.gemeente} onClick={()=>selecteer(g)}
                  style={{background:isSelected?"#eb7e1315":"#ffffff",
                    border:"1px solid "+(isSelected?displayKleur:"#fdf9f4"),
                    borderRadius:7,padding:"7px 10px",cursor:"pointer"}}>
                  <div style={{display:"flex",justifyContent:"space-between",
                    alignItems:"center",marginBottom:4}}>
                    <div style={{flex:1,minWidth:0}}>
                      <div style={{fontWeight:700,color:"#1a1208",fontSize:12,
          ...
          <div style={{borderTop:"1px solid #e8dcc8",padding:"8px 9px"}}>
            <button onClick={()=>setEigenModus(!eigenModus)}
              style={{width:"100%",background:"transparent",
                border:"1px solid #e8dcc8",borderRadius:7,
                padding:"6px",color:"#8a7860",fontSize:11,cursor:"pointer"}}>
            ...
            {eigenModus && (
              <div style={{marginTop:7,display:"flex",flexDirection:"column",gap:5}}>
                ...
                <textarea value={eigenTekst} onChange={e=>setEigenTekst(e.target.value)}
                  ...
                  style={{background:"#fdf9f4",border:"1px solid #e8dcc8",
                    borderRadius:6,padding:"6px 9px",color:"#1a1208",
                    fontSize:11,outline:"none",resize:"vertical"}} />
                <button onClick={analyseEigen}
                  style={{background:"linear-gradient(135deg,#1A7A4A,#eb7e13)",
        ...
        <div style={ST.right}>
              ...
              {geselecteerd && (
                <div style={ST.card}>
                  <div style={{display:"flex",justifyContent:"space-between",
                    ...
                    <div>
                      <div style={{fontSize:17,fontWeight:800,color:"#1a1208"}}>
                    ...
                    <div style={{background:"#fdf9f4",border:"1px solid #e8dcc8",
                      borderRadius:8,padding:"8px 14px",textAlign:"center"}}>
                      <div style={{fontSize:22,fontWeight:800,color:"#1a1208"}}>
                        {selAnalyses[0]?.pct}%
                      </div>
                      <div style={{fontSize:9,color:"#8a7860"}}>top match</div>
                    </div>
                  </div>
                  <div style={{display:"flex",flexDirection:"column",gap:8,marginBottom:10}}>
                    {selAnalyses.slice(0,3).map(p=>(
                      <div key={p.id} style={{display:"flex",alignItems:"center",gap:8}}>
                        ...
                        <span style={{fontSize:11,color:"#1a1208",width:145,flexShrink:0}}>{p.label}</span>
                  ...
                  <div style={{borderTop:"1px solid #e8dcc8",paddingTop:10}}>
                    <div style={{fontSize:11,fontWeight:700,color:"#1a1208",marginBottom:6}}>
                      🤖 AI Kansen Analyse
                    </div>
                    {aiLoading ? (
                      <div style={{color:"#8a7860",fontSize:12}}>Analyseren...</div>
                    ) : aiTekst ? (
                      <div style={{fontSize:12,color:"#3a2a14",lineHeight:1.7,whiteSpace:"pre-wrap"}}>
                        {aiTekst}
                      </div>
                    ) : null}
                  </div>
                  <div style={{borderTop:"1px solid #e8dcc8",paddingTop:10,marginTop:4,display:"flex",gap:8,flexWrap:"wrap"}}>
                    <a href={getAkkoordUrl(geselecteerd.gemeente)} target="_blank" rel="noopener noreferrer"
                      style={{display:"flex",alignItems:"center",gap:5,background:"#eb7e13",
                        border:"none",borderRadius:7,padding:"7px 12px",
                        color:"#fff",fontSize:11,fontWeight:700,cursor:"pointer",textDecoration:"none"}}>
                      📄 Zoek coalitieakkoord
                    </a>
                    <a href={getGemeenteWebsite(geselecteerd.gemeente)} target="_blank" rel="noopener noreferrer"
                      style={{display:"flex",alignItems:"center",gap:5,background:"#fdf9f4",
                        border:"1px solid #e8dcc8",borderRadius:7,padding:"7px 12px",
                        color:"#3a2a14",fontSize:11,fontWeight:600,cursor:"pointer",textDecoration:"none"}}>
                      🌐 Gemeentewebsite
                    </a>
                  </div>
                </div>
          ...
          {tab==="analyse" && (
            !geselecteerd ? (
              <div style={{...ST.card,textAlign:"center",padding:36}}>
                ...
                <div style={{fontSize:13,color:"#8a7860",fontWeight:600}}>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:12}}>
                <div style={ST.card}>
                  <div style={{display:"flex",justifyContent:"space-between",
                    ...
                    <div style={{flex:1}}>
                      <div style={{fontSize:19,fontWeight:800,color:"#1a1208",marginBottom:4}}>
                      ...
                      <div style={{display:"flex",flexWrap:"wrap",gap:3}}>
                        {geselecteerd.themas.slice(0,8).map(t=>(
                          <span key={t} style={{background:"#e8d8c0",color:"#5a4228",
                            borderRadius:4,padding:"2px 6px",fontSize:10}}>{t}</span>
                        ))}
                        {geselecteerd.themas.length>8&&(
                          <span style={{color:"#8a7860",fontSize:10}}>
                            +{geselecteerd.themas.length-8}
                          </span>
                        )}
                      </div>
                    ...
                    <div style={{background:"#fdf9f4",border:"1px solid #e8dcc8",
                      ...
                      <div style={{fontSize:24,fontWeight:800,color:"#1a1208"}}>
                        {selAnalyses[0]?.pct}%
                      </div>
                      <div style={{fontSize:9,color:"#8a7860"}}>Top match</div>
                    </div>
                ...
                <div style={ST.card}>
                  <div style={{fontSize:12,fontWeight:700,color:"#1a1208",marginBottom:12}}>
                    ...
                    {selAnalyses.map(p=>(
                      <div key={p.id}>
                        <div style={{display:"flex",alignItems:"center",gap:7,marginBottom:3}}>
                          <span style={{fontSize:14}}>{p.icon}</span>
                          <span style={{fontSize:11,color:"#1a1208",fontWeight:600,
                ...
                <div style={ST.card}>
                  <div style={{fontSize:12,fontWeight:700,color:"#1a1208",marginBottom:10}}>
                ...
                <div style={ST.card}>
                  <div style={{fontSize:12,fontWeight:700,color:"#1a1208",marginBottom:8}}>
                    🤖 AI Kansen Analyse - {geselecteerd.gemeente}
                  </div>
                  {aiLoading ? (
                    <div style={{color:"#8a7860",fontSize:12}}>Analyseren...</div>
                  ) : aiTekst ? (
                    <div style={{fontSize:12,color:"#3a2a14",lineHeight:1.75,whiteSpace:"pre-wrap"}}>
                      {aiTekst}
                    </div>
                  ) : (
                    <div style={{color:"#8a7860",fontSize:12}}>
                ...
                {CTMH_MENSEN.map(m => {
                  ...
                  return (
                    <div key={m.id}
                      ...
                      style={{
                        background:isActief?m.kleur+"18":"#ffffff",
                        border:"1px solid "+(isActief?m.kleur:"#e8d8c0"),
                      ...
                      <div style={{display:"flex",alignItems:"flex-start",gap:10,marginBottom:10}}>
                        ...
                        <div style={{flex:1,minWidth:0}}>
                          <div style={{fontWeight:700,color:"#1a1208",fontSize:13}}>
                            {m.naam}
                            {!m.beschikbaar && (
                              <span style={{marginLeft:6,fontSize:9,color:"#8a7860",
                                background:"#e8d8c0",borderRadius:4,padding:"1px 5px"}}>
                                Op opdracht
                              </span>
                            )}
                          </div>
                          ...
                          <div style={{fontSize:9,color:"#8a7860",marginTop:2}}>
                            📍 {m.regio}
                          </div>
                        </div>
                      </div>
                      <div style={{fontSize:11,color:"#5a4228",lineHeight:1.55,marginBottom:10}}>
                        {m.bio}
                      </div>
                      ...
                      {topMatches.length>0 && (
                        <div style={{borderTop:"1px solid #e8dcc8",paddingTop:8}}>
                          <div style={{fontSize:9,color:"#8a7860",fontWeight:700,
                            ...
                            {topMatches.map(g=>(
                              <div key={g.gemeente}
                                ...
                                style={{display:"flex",alignItems:"center",gap:7,
                                  padding:"4px 8px",borderRadius:6,background:"#fdf9f4",
                                  cursor:"pointer"}}>
                                <span style={{fontSize:11,color:"#1a1208",fontWeight:600,flex:1}}>
                                  {g.gemeente}
                                </span>
                                <span style={{fontSize:9,color:"#8a7860"}}>{g.provincie.split("-")[0]}</span>
          ...
          {tab==="matrix" && (
            <div style={ST.card}>
              <div style={{fontSize:12,fontWeight:700,color:"#1a1208",marginBottom:4}}>
              ...
              <div style={{overflowX:"auto"}}>
                <table style={{width:"100%",borderCollapse:"collapse",fontSize:11}}>
                  <thead>
                    <tr style={{borderBottom:"1px solid #e8dcc8"}}>
                      <th style={{textAlign:"left",color:"#8a7860",padding:"6px 10px",fontWeight:600}}>Gemeente</th>
                      <th style={{textAlign:"left",color:"#8a7860",padding:"6px 8px",fontWeight:400,fontSize:10}}>Provincie</th>
                      {CTMH_PROFIELEN.map(p=>(
                  ...
                  <tbody>
                    {gefilterd.slice(0,200).map(g=>(
                      <tr key={g.gemeente}
                        ...
                        <td style={{padding:"5px 10px",color:"#1a1208",fontWeight:600,fontSize:11}}>
                          {g.gemeente}
                        </td>
                        ...
                        {CTMH_PROFIELEN.map(p=>{
                          ...
                          return (
                            <td key={p.id} style={{padding:"5px 4px",textAlign:"center"}}>
                              <div style={{
                                background:pct>=60?p.kleur:pct>=35?p.kleur+"77":pct>=15?p.kleur+"33":"#e8d8c0",
                                borderRadius:4,padding:"2px 4px",fontSize:10,fontWeight:700,
                                color:pct>=35?"#fff":pct>=15?p.kleur:"#1a1208",
                ...
                {gefilterd.length>200&&(
                  <div style={{textAlign:"center",color:"#8a7860",fontSize:10,marginTop:8}}>
          ...
          {tab==="strategie" && (
            <div style={{display:"flex",flexDirection:"column",gap:12}}>
              {weekUpdate && !weekLoading && (
                <div style={{...ST.card,borderColor:"#e8d8c0"}}>
                  <div style={{fontSize:12,fontWeight:700,color:"#eb7e13",marginBottom:8}}>
              ...
              <div style={ST.card}>
                ...
                {stratLoading?(
                  ...
                  <button onClick={laadStrategie}
                    style={{background:"linear-gradient(135deg,#eb7e13,#8c6848)",
                      ...
                      <div style={{display:"flex",gap:4,flexWrap:"wrap"}}>
                        {top5.map(g=>(
                          <div key={g.gemeente}
                            ...
                            <div style={{fontSize:11,color:"#1a1208",fontWeight:600}}>
                              {g.gemeente}
                            </div>
                            <div style={{display:"flex",justifyContent:"space-between",
          ...
          {tab==="tips" && (
            <div style={{display:"flex",flexDirection:"column",gap:10}}>
              {[
                {nr:"01",kleur:"#eb7e13",icon:"📥",titel:"Laad actuele akkoorden via PDF-URL",
                ...
                {nr:"02",kleur:"#7a98ad",icon:"🔢",titel:"Verfijn keyword-weging met domeinkennis",
                ...
                {nr:"03",kleur:"#68749c",icon:"📅",titel:"Koppel aan de gemeentelijke begrotingscyclus",
                ...
                {nr:"04",kleur:"#eb7e13",icon:"📊",titel:"Integreer vacaturedata als validatie",
                ...
                {nr:"05",kleur:"#8c6848",icon:"🗺️",titel:"Voeg arbeidsmarktregio's toe als clustering",
                ...
                {nr:"06",kleur:"#68749c",icon:"🧠",titel:"Gebruik NLP voor bedragen en aantallen",
                ...
                {nr:"07",kleur:"#eb7e13",icon:"🔄",titel:"Monitor tussentijdse bijstellingen",
                ...
                {nr:"08",kleur:"#7a98ad",icon:"🤝",titel:"Voeg politieke kleur toe als variabele",
                ...
                <div key={tip.nr} style={{background:"#ffffff",borderRadius:10,
                  padding:"13px 16px",
                  ...
                  <div style={{display:"flex",alignItems:"center",gap:7,marginBottom:5}}>
                    ...
                    <span style={{fontSize:12,fontWeight:700,color:"#1a1208"}}>{tip.titel}</span>
                  </div>
                  <div style={{fontSize:11,color:"#5a4228",lineHeight:1.65,paddingLeft:25}}>
                    {tip.tekst}
                  </div>
                </div>
              ))}
